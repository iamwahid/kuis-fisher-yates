...
public class HasilSkoring extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MediaPlayer player = MediaPlayer.create(HasilSkoring.this, R.raw.suarabilalhebat);
        player.start();
        ...
        btnDetail.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
                Intent i = new Intent(HasilSkoring.this, DetailActivity.class);
                startActivity(i);
            }
        });
    ...
    public void setSkor(){
        ...
        String skorKuis2Gambar = getIntent().getStringExtra("skorAkhirKuis2Gambar");
        ...
        }else if (activity.equals("Kuis2Gambar")){
            mtvHasilAkhir.setText("SKOR : "+skorKuis2Gambar);
        }
